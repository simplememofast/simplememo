...
# 走らせ方: BLINDSPOT_SCRATCH=<ci-steps.json を置いた作業ディレクトリ> \
#           python3 scripts/lib/blindspot-scan.py
...
if not SCRATCH:
    raise SystemExit('BLINDSPOT_SCRATCH（ci-steps.json を置いた作業ディレクトリ）を env で指定する')
