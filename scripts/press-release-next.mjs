...
// Owner reaffirmed the pre-dispatch goal on 2026-09-11; compare unrounded ratios.
export const OWNER_TARGET_AI_EXECUTION_RATE = 0.999;
...
export function validate(manifest, draft) {
  ...
  if (manifest?.target_ai_execution_rate !== OWNER_TARGET_AI_EXECUTION_RATE) errors.push('The owner target is 99.9%; do not change it without a new owner instruction');
