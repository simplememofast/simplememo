...
| 指標 | 値 | 分母 |
|---|---:|---|
| **総合自動化率** | **34.1%** | 定義タスク 170（未実装を含む・**最も厳しい**） |
| AI実行率 | 51.3% | 実施中タスク 107（未実装を除く） |
| AI関与率 | 83.2% | 同上（提案・下書きまで含める・**最も甘い**） |
| カバー率 | 66.5% | そもそも誰かがやっているタスクの割合 |

内訳: 自律 6 / ゲート付き実行 52 / 提案 36 / 人間 19 / **未実装 57** / 意図的にやらない 2
...
- **総合自動化率 34.1%** — 「あるべきタスクのうちAIが実行しているのは3割」。**これが現在地**
- **カバー率 66.5%** — 3割強は**誰もやっていない**。自動化以前に未着手
