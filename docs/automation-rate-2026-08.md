...
| 指標 | 値 | 分母 |
|---|---:|---|
| **総合自動化率** | **31.2%** | 定義タスク 170（未実装を含む・**最も厳しい**） |
| AI実行率 | 49.5% | 実施中タスク 107（未実装を除く） |
| AI関与率 | 83.2% | 同上（提案・下書きまで含める・**最も甘い**） |
| カバー率 | 62.9% | そもそも誰かがやっているタスクの割合 |

内訳: 自律 2 / ゲート付き実行 51 / 提案 36 / 人間 18 / **未実装 63** / 意図的にやらない 2
...
- **総合自動化率 31.2%** — 「あるべきタスクのうちAIが実行しているのは3割」。**これが現在地**
