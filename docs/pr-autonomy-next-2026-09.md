# Obsidian連携シンプルメモ、アプリ運営のAI実行率83.6%を公開

<!-- fact-check: draft -->

実施中177業務のうち148業務をAIが実行。未着手を含む総合自動化率は74.4%。実装・検証・本番反映の証拠と残る業務を公開
...
棚卸しした203業務のうち、意図的に実施しない4業務を除く199業務を対象にしています。内訳は、AIが実行148件、AIが提案・下書きまで12件、人が担当17件、未着手22件です。

AI実行率：83.6%（148/177、実施中の業務が分母）
総合自動化率：74.4%（148/199、未着手も分母に含む）
