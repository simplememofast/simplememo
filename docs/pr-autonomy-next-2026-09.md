# Obsidian連携シンプルメモ、アプリ運営のAI実行率85.4%を公開

<!-- fact-check: draft -->

実施中178業務のうち152業務をAIが実行。未着手を含む総合自動化率は76.4%。実装・検証・本番反映の証拠と残る業務を公開
...
棚卸しした203業務のうち、意図的に実施しない4業務を除く199業務を対象にしています。内訳は、AIが実行152件、AIが提案・下書きまで10件、人が担当16件、未着手21件です。

AI実行率：85.4%（152/178、実施中の業務が分母）
総合自動化率：76.4%（152/199、未着手も分母に含む）
AI関与率：91.0%（提案・下書きまでの業務も含む）
カバー率：89.4%（178/199、誰かが実施している業務の割合）
