# Obsidian連携シンプルメモ、アプリ運営のAI実行率86.0%を公開

<!-- fact-check: draft -->

実施中178業務のうち153業務をAIが実行。未着手を含む総合自動化率は76.9%。実装・検証・本番反映の証拠と残る業務を公開
...
棚卸しした203業務のうち、意図的に実施しない4業務を除く199業務を対象にしています。内訳は、AIが実行153件、AIが提案・下書きまで9件、人が担当16件、未着手21件です。

AI実行率：86.0%（153/178、実施中の業務が分母）
総合自動化率：76.9%（153/199、未着手も分母に含む）
